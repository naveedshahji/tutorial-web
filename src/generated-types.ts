...
export type AddDealMutation = { __typename?: 'Mutation', addDeal: { __typename?: 'Deal', _id: string, name: string, link: string } };

export type DealsQueryVariables = Exact<{ [key: string]: never; }>;


export type DealsQuery = { __typename?: 'Query', deals: Array<{ __typename?: 'Deal', _id: string, name: string, userId: string, link: string }> };
...
export type DeleteDealsMutation = { __typename?: 'Mutation', deleteDeals: { __typename?: 'Deal', _id: string } };
...
export const AddDealDocument = gql`
    mutation addDeal($addDealData: AddDealInput!) {
  addDeal(addDealData: $addDealData) {
    _id
    name
    link
  }
  ...
  export class AddDealGQL extends Apollo.Mutation<AddDealMutation, AddDealMutationVariables> {
    document = AddDealDocument;
...
export const DealsDocument = gql`
  ...
  export class DealsGQL extends Apollo.Query<DealsQuery, DealsQueryVariables> {
    document = DealsDocument;
...
export const DeleteDealsDocument = gql`
    mutation deleteDeals($deleteDeals: DeleteDealInput!) {
  deleteDeals(deleteDeals: $deleteDeals) {
    _id
  }
}
    `;
  ...
  export class DeleteDealsGQL extends Apollo.Mutation<DeleteDealsMutation, DeleteDealsMutationVariables> {
    document = DeleteDealsDocument;
